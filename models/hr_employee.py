...
class HrEmployee(models.Model):
    ...
    def create(self,vals):
        try:   
            ...
            annual_leave_type = self.env['hr.leave.type'].sudo().search(['&',('finished_carry_froword','=',False),'|','&',('validity_start','>=',commencement_business),('validity_stop','<=',commencement_business),'&',('validity_start','=',False),('validity_stop','=',False)])
